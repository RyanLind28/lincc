        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600">
              <li><Link to="/#how-it-works" className="hover:text-purple transition-colors">How it works</Link></li>
              <li><Link to="/#features" className="hover:text-purple transition-colors">Features</Link></li>
              <li><Link to="/#waitlist" className="hover:text-purple transition-colors">Join waitlist</Link></li>
            </ul>
          </div>
          <div>
