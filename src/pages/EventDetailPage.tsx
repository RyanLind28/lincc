...
export default function EventDetailPage() {
  ...
  // Initialize participants hook with event's join mode
  const {
    participants,
    userStatus,
    pendingCount,
    ...
    join,
    leave,
  } = useEventParticipants(id, event?.join_mode || 'request');
  ...
  // Calculate distance (placeholder - would use user's location)
  const distanceKm = event ? 0.5 : 0; // TODO: Calculate from user location
