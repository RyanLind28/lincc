...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'fitness-running', label: 'Running', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'sports-badminton', label: 'Badminton', image: 'https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=400&h=300&fit=crop' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'outdoors-park', label: 'Park hangout', image: 'https://images.unsplash.com/photo-1502784444187-359ac186c5bb?w=400&h=300&fit=crop' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'wellness-spa', label: 'Spa day', image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&h=300&fit=crop' },
  ...
  },
  {
    ...
    subcategories: [
      { value: 'gaming-videogames', label: 'Video games', image: 'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=400&h=300&fit=crop' },
